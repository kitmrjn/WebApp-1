            ...
            <?php foreach ($answers as $answer): ?>
                <div class="answer-item">
                    <div class="answer-main">
                        <h3>
                            <a href="/webapp/questions/question?id=<?php echo $answer['question_id']; ?>#answer-<?php echo $answer['answer_id']; ?>">
                    ...
                    <div class="answer-actions">
                        <a href="/webapp/questions/question?id=<?php echo $answer['question_id']; ?>#answer-<?php echo $answer['answer_id']; ?>" class="btn-view">
