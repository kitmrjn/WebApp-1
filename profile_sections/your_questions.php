...
<section class="content-section">
            ...
            <?php foreach ($questions as $question): ?>
                <div class="question-item">
                    <div class="question-main">
                        <h3>
                            <a href="question?id=<?php echo $question['question_id']; ?>">
                    ...
                    <div class="question-actions">
                        <a href="question?id=<?php echo $question['question_id']; ?>" class="btn-view">
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <a href="post_question.php" class="btn-ask">Ask Your First Question</a>
        </div>
    <?php endif; ?>
</section>